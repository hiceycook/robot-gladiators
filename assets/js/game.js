...
var fight = function (enemy) {
    ...
    while (enemy.health > 0 && playerInfo.health > 0) {
        ...
        if (isPlayerTurn) {
            ...
            // IF NOT SKIPPED THEN FIGHT ROUND BEGINS
            ...
            if (enemy.health <= 0) {
                ...
                // Add 20 credits for killing enemy player
...
var endGame = function () {
    ...
    if (playerInfo.money > highScore) {
        ...
        alert(playerInfo.name + " did not beat " + localStorage.getItem("name") + "'s" + " high score of " + highScore + ". Maybe next time!");
    }
...
var shop = function () {
    var shopOptionPrompt = window.prompt(
        "Would you like to REFILL your health, UPGRADE your attack, or LEAVE the store? Please enter Please enter one 1 for REFILL, 2 for UPGRADE, or 3 for LEAVE."
    );
...
var fightOrSkip = function () {
    ...
    // return false if player does not want to skip
    return false;
}
...
var playerInfo = {
    ...
    refillHealth: function () {
        if (this.money >= 7) {
            window.alert("Refilling Health by 20 at the cost of 7 points");
            this.health += 20;
            this.money -= 7;
        } else {
    ...
    upgradeAttack: function () {
        if (this.money >= 7) {
            window.alert("Upgrading Attack by 6 at the cost of 7 points");
            this.attack += 6;
            this.money -= 7;
        } else {
            window.alert("You don't have enough money!")
